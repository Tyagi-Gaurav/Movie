...
public class MovieResource {
    ...
    public ResponseEntity<Void> createMovieDetails(@RequestBody MovieCreateRequestDTO movieCreateRequestDTO,
    ...
    public ResponseEntity<MoviesDTO> getMovieDetails(@RequestAttribute("userProfile") UserProfile userProfile,
                                                     @RequestParam(value = "userId", required = false) String userId) {
    ...
    public ResponseEntity<Void> deleteMovieDetails(@RequestAttribute("userProfile") UserProfile userProfile,
    ...
    public ResponseEntity<Void> updateMovieDetails(@RequestBody MovieUpdateRequestDTO movieUpdateRequestDTO,
                                                   @RequestAttribute("userProfile") UserProfile userProfile,
                                                   @RequestParam(value = "userId", required = false) String userId) {
        ...
        Movie movie = ImmutableMovie.builder()
                ...
                .movieVideo(Optional.ofNullable(movieUpdateRequestDTO.videoRequestDto())
                        .map(video -> ImmutableMovieVideo.builder()
                                .content(video.content()).build()))
                .build();
