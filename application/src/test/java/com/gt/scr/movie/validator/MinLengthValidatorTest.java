...
class MinLengthValidatorTest {
    ...
    void shouldThrowExceptionWhenMinLengthIsLessThanOrZero(String value) {
        MinLengthValidatorTest.TestMinLengthValidator underTest = new MinLengthValidatorTest.TestMinLengthValidator(value);
        Set<ConstraintViolation<MinLengthValidatorTest.TestMinLengthValidator>> violations =
