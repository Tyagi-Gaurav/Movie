...
@SpringBootTest(classes = {DuplicateRecordExceptionHandlerTest.TestDuplicateRecordResource.class,
        DuplicateRecordExceptionHandler.class})
@ActiveProfiles("DuplicateRecordExceptionHandlerTest")
class DuplicateRecordExceptionHandlerTest {
    ...
    void shouldHandleAuthenticationException() throws Exception {
        ...
        assertThat(testErrorResponse.message()).isEqualTo("Duplicate User");
    }

    @ControllerAdvice
    @RestController
    @Profile("DuplicateRecordExceptionHandlerTest")
    static class TestDuplicateRecordResource {
