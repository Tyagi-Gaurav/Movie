...
public class ContentUploadResource {
    ...
    public Mono<ByteStreamUploadResponseDTO> uploadStream(@RequestBody ByteStreamUploadDTO byteStreamUploadDTO) {
        return securityContextHolder.getContext(UserProfile.class)
                ...
                ).map(movieStreamMetaData -> new ByteStreamUploadResponseDTO(byteStreamUploadDTO.movieId(),
