...
app.post("/submit", (req, res) => {
  ...
  //Then:
  let randomAdjIndex = Math.floor(1 + adj.length * Math.random());
  let randomNounIndex = Math.floor(1 + noun.length * Math.random());
  //1. You should randomly pick an adjective from the const "adj" and a noun from const "noun",
  //scroll down to see the two arrays.
  let randomAdj = adj[randomAdjIndex];
  let randomNoun = noun[randomNounIndex];

  //2. Send the index.ejs as a response and add the adjective and noun to the res.render
  res.locals.bandName = randomAdj + " " + randomNoun;
