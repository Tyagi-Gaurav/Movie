package com.gt.scr.user.security;

import com.gt.scr.user.config.AuthenticationManager;
import com.gt.scr.user.config.SecurityContextRepository;
...
public class UserWebSecurityConfig {
    ...
    SecurityWebFilterChain springWebFilterChain(ServerHttpSecurity httpSecurity,
        ...
        return httpSecurity
                ...
                .pathMatchers("/status", "/actuator/**", "/user").permitAll()
